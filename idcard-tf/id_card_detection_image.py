...
# Using Image to crop and save the extracted copied image
image_path='C:\\Users\\ELZAHBIA\\Downloads\\id-card-detector-master\\test_images\\image.jpg'
im = Image.open(image_path)

   
     
output_path='C:\\Users\\ELZAHBIA\\Downloads\\id-card-detector-master\\test_images\\images.jpg'
...
imaa = cv2.imread(image_path)
cv2.imshow("nocards: ", imaa)
